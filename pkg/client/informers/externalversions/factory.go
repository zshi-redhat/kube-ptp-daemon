...
import (
	...
	ptp "github.com/zshi-redhat/kube-ptp-daemon/pkg/client/informers/externalversions/ptp"
...
func (f *sharedInformerFactory) Ptp() ptp.Interface {
	return ptp.New(f, f.namespace, f.tweakListOptions)
}
